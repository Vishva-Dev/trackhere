        ...
        <div className="relative min-h-screen flex items-center justify-center bg-[#fcfdfe] p-6 overflow-hidden">
            ...
            <div className="max-w-[400px] w-full relative z-10">
                ...
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-2xl font-black text-slate-800 tracking-tight">Welcome <span className="text-indigo-600">Back</span></h1>
                    <p className="text-slate-400 text-sm font-medium mt-1">Sign in to track your expenses</p>
                </div>
